...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SourceforgeLibraryAccessors laccForSourceforgeLibraryAccessors = new SourceforgeLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at libreria
     */
    ...
    /**
     * Returns the group of libraries at sourceforge
     */
    public SourceforgeLibraryAccessors getSourceforge() {
        return laccForSourceforgeLibraryAccessors;
    }
    ...
    public static class LibreriaLibraryAccessors extends SubDependencyFactory {
        ...
        public LibreriaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for pcs (com.github.programadores:LibreriaPcs)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class SourceforgeLibraryAccessors extends SubDependencyFactory {

        public SourceforgeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getJtds() {
                return create("sourceforge.jtds");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: libpcs (1.0.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLibpcs() { return getVersion("libpcs"); }
